<x-app-layout>
    <div class="flex h-screen bg-gray-50">
        ...
        <!-- Sidebar -->
        <aside id="sidebar"
            class="fixed lg:static inset-y-0 left-0 w-64 bg-white border-r border-gray-200 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 z-40">
            ...
            <div class="p-4 lg:p-8">
                ...
                @if ($activeConfig)
                    <div class="mb-4 lg:mb-6">
                        <div
                            class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4 lg:p-5">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 mb-1">
                                            ...
                                            <span
                                                class="px-2 py-0.5 bg-green-600 text-white text-xs font-medium rounded-full">En
                                                cours</span>
                                        </div>
                                        <p class="text-sm lg:text-base text-gray-900 font-semibold">
                                            {{ $activeConfig->channel_name }}</p>
                                        <p class="text-xs text-gray-600 mt-0.5">Les messages seront envoyés via cette
                                            chaîne</p>
                                    </div>
                                </div>

                                <a href="{{ route('twilio.config') }}"
                                    class="inline-flex items-center px-3 lg:px-4 py-2 bg-white text-gray-700 border border-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 transition">
                            ...
                            <div class="mt-3 pt-3 border-t border-green-200">
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-xs">
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-900 font-mono ml-1">{{ substr($activeConfig->account_sid, 0, 10) }}...</span>
                                    </div>
                                    <div>
                                        <span class="text-gray-600">Content SID:</span>
                                        <span
                                            class="text-gray-900 font-mono ml-1">{{ substr($activeConfig->content_sid, 0, 10) }}...</span>
                                    </div>
                                    <div>
                                        <span class="text-gray-600">Dernière MAJ:</span>
                                        <span
                                            class="text-gray-900 ml-1">{{ $activeConfig->updated_at->format('d/m/Y') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 lg:p-5">
                            <div class="flex items-center justify-between flex-wrap gap-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 class="text-sm lg:text-base font-bold text-yellow-900 mb-1">Aucune chaîne
                                            active</h4>
                                        <p class="text-xs lg:text-sm text-yellow-700">Vous devez configurer et activer
                                            une chaîne WhatsApp pour envoyer des messages</p>
                                    </div>
                                </div>

                                <a href="{{ route('twilio.config') }}"
                                    class="inline-flex items-center px-3 lg:px-4 py-2 bg-yellow-600 text-white text-sm font-medium rounded-lg hover:bg-yellow-700 transition">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <button onclick="selectAll()"
                                class="text-xs text-indigo-600 hover:text-indigo-800 font-medium">Tout
                                sélectionner</button>
                        ...
                        <table class="w-full min-w-[600px]">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th
                                        class="px-4 lg:px-6 py-3 lg:py-4 text-left text-xs font-semibold text-gray-600 uppercase">
                                        ID</th>
                                    <th
                                        class="px-4 lg:px-6 py-3 lg:py-4 text-left text-xs font-semibold text-gray-600 uppercase">
                                        Numéro</th>
                                ...
                                @forelse($messages as $message)
                                    <tr class="hover:bg-gray-50 transition contact-row"
                                        ...
                                        <td class="px-4 lg:px-6 py-3 lg:py-4">
                                            <input type="checkbox"
                                                class="contact-checkbox w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
                                                value="{{ $message->id }}" onchange="updateSelection()">
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="7" class="px-4 lg:px-6 py-8 lg:py-16 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-gray-900 font-medium text-base lg:text-lg mb-1">Aucun
                                                    contact trouvé</p>
                                                <p class="text-gray-500 text-xs lg:text-sm mb-4 lg:mb-6">Commencez par
                                                    ajouter vos premiers contacts</p>
                                                <button onclick="openModal('addModal')"
                                                    ...
                                                    <svg class="w-4 h-4 lg:w-5 lg:h-5 mr-2" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div id="alertModal"
        class="hidden fixed inset-0 bg-black bg-opacity-50 z-[9000] flex items-center justify-center p-4">
        <div class="bg-white rounded-xl p-6 lg:p-8 max-w-md w-full mx-4 modal-content">
            <div class="flex items-center mb-4 lg:mb-6">
                <div id="alertIcon"
                    class="w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
    ...
    <div id="confirmationModal"
        ...
        <div class="bg-white rounded-xl p-6 lg:p-8 max-w-md w-full mx-4 modal-content">
            ...
            <div class="mb-4 lg:mb-6">
                <p class="text-gray-700 text-sm lg:text-base" id="confirmMessage">Êtes-vous sûr de vouloir continuer ?
                </p>
            </div>
            <div class="flex gap-3 justify-end">
                <button onclick="closeModal('confirmationModal')"
                    class="px-4 lg:px-6 py-2 lg:py-2.5 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition text-sm lg:text-base">
                    Annuler
                </button>
            ...
            <form method="POST" action="{{ route('contacts.store') }}" id="addContactForm"
                ...
                <div class="space-y-3 lg:space-y-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">L'indicatif +225 sera ajouté automatiquement si absent
                        </p>
                    </div>
            ...
            <form method="POST" action="{{ route('contacts.import') }}" enctype="multipart/form-data"
                ...
                <div class="mb-4 lg:mb-6">
                    ...
                    <label for="csvFile"
                        ...
                        <svg class="w-8 h-8 lg:w-10 lg:h-10 text-gray-400 mb-1 lg:mb-2" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12">
                            </path>
                        </svg>
                        <p class="text-xs lg:text-sm font-medium text-gray-600" id="fileLabel">Cliquez pour
                            sélectionner</p>
                ...
                <div id="importProgressContainer" class="hidden mb-4 lg:mb-6">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm font-medium text-gray-700" id="importProgressText">Importation en
                            cours...</span>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2 lg:h-2.5 overflow-hidden">
                        <div id="importProgressBar"
                            class="bg-gradient-to-r from-indigo-500 to-purple-600 h-2 lg:h-2.5 rounded-full transition-all duration-300"
                            style="width: 0%"></div>
                    </div>
                ...
                <div class="flex gap-2 lg:gap-3">
                    <button type="button" onclick="startImport()" id="importButton"
    ...
    <div id="deleteModal"
        ...
        <div class="bg-white rounded-xl p-6 lg:p-8 max-w-md w-full mx-4 modal-content">
            <div
                class="w-12 h-12 lg:w-16 lg:h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-3 lg:mb-4">
                <svg class="w-6 h-6 lg:w-8 lg:h-8 text-red-600" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p class="text-xs lg:text-sm text-gray-600 text-center mb-4 lg:mb-6">Êtes-vous sûr de vouloir supprimer ce
                contact ? Cette action est irréversible.</p>
    ...
    <div id="deleteCampaignModal"
        ...
        <div class="bg-white rounded-xl p-6 lg:p-8 max-w-md w-full mx-4 modal-content">
            ...
            <p class="text-xs lg:text-sm text-gray-600 text-center mb-4 lg:mb-6">Tous les contacts de cette campagne
                seront supprimés. Cette action est irréversible.</p>
    ...
    <div id="sendCampaignModal"
        ...
        <div class="bg-white rounded-xl p-6 lg:p-8 modal-with-progress mx-4 modal-content max-w-2xl">
            <div
                class="w-12 h-12 lg:w-16 lg:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 lg:mb-4">
            ...
            <p class="text-xs lg:text-sm text-gray-600 text-center mb-4 lg:mb-6">Choisissez les contacts qui recevront
                le message WhatsApp</p>

            <form id="sendCampaignForm">
                <!-- Sélection de campagne -->
                <div class="mb-4 lg:mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Campagne *</label>
                    <select name="campagne" id="campagneSelect" required onchange="updateCampaignInfo()"
                        ...
                        @foreach ($campagnes as $campagne)
                            <option value="{{ $campagne }}"
                                data-count="{{ \App\Models\MessageWhatsapp::where('nom_campagne', $campagne)->count() }}"
                                data-not-sent="{{ \App\Models\MessageWhatsapp::where('nom_campagne', $campagne)->whereNull('date_envoi')->count() }}">
                                {{ $campagne }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4 lg:mb-6">
                    ...
                    <div class="space-y-2">
                        <label
                            ...
                            <input type="radio" name="send_mode" value="all" class="w-4 h-4 text-blue-600"
                                checked onchange="updateSendMode()">
                            <span class="ml-3 text-sm">
                                <span class="font-medium text-gray-900">Tous les contacts</span>
                                <span class="block text-xs text-gray-500 mt-1">Envoyer à tous les contacts de la
                                    campagne</span>
                            </span>
                        </label>
                        ...
                        <label
                            class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition">
                            <input type="radio" name="send_mode" value="limit" class="w-4 h-4 text-blue-600"
                        ...
                        <label
                            class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition">
                            <input type="radio" name="send_mode" value="range" class="w-4 h-4 text-blue-600"
                                onchange="updateSendMode()">
                            <span class="ml-3 text-sm">
                ...
                <div id="limitOptions" class="mb-4 lg:mb-6 hidden">
                    ...
                    <input type="number" name="limit" id="limitInput" min="1" placeholder="Ex: 200"
                        class="w-full px-3 lg:px-4 py-2 lg:py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
                ...
                <div id="rangeOptions" class="mb-4 lg:mb-6 hidden">
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="number" name="range_start" id="rangeStart" min="1" placeholder="1"
                                class="w-full px-3 lg:px-4 py-2 lg:py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Au contact</label>
                            <input type="number" name="range_end" id="rangeEnd" min="1" placeholder="200"
                                class="w-full px-3 lg:px-4 py-2 lg:py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                </div>
                ...
                <div id="sendSummary" class="mb-4 lg:mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg hidden">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-700 mt-1" id="summaryDetails">Sélectionnez une campagne et un
                                mode d'envoi</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="sendProgressContainer" class="hidden mb-4 lg:mb-6">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2 lg:h-2.5 overflow-hidden">
                        <div id="sendProgressBar"
                            class="bg-gradient-to-r from-blue-500 to-purple-600 h-2 lg:h-2.5 rounded-full transition-all duration-300"
                            style="width: 0%"></div>
                    </div>
                    <div class="flex justify-between text-xs text-gray-500 mt-2">
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 lg:p-4 mb-4 lg:mb-6">
                    <div class="flex items-start">
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-yellow-600 mr-2 flex-shrink-0 mt-0.5"
                ...
                <div class="flex gap-2 lg:gap-3">
                    <button type="button" onclick="closeModal('sendCampaignModal')" id="cancelSendButton"
                        class="flex-1 px-3 lg:px-4 py-2 lg:py-2.5 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition text-sm lg:text-base">
                        Annuler
                    </button>
                    <button type="button" onclick="startCampaignSend()" id="sendCampaignButton"
                    ...
                    <button type="button" onclick="stopCampaignSend()" id="stopSendButton"
                        class="flex-1 px-3 lg:px-4 py-2 lg:py-2.5 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition text-sm lg:text-base hidden">
                        Arrêter
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        // Variables pour le suivi en temps réel
        let importInterval = null;
        let campaignInterval = null;
        let currentImportOperationId = null;
        let currentCampaignOperationId = null;
        ...
        // =====================================================
        // SYSTÈME DE PROGRESSION EN TEMPS RÉEL - IMPORT
        // =====================================================

        /**
         * Démarre le suivi de progression d'import
         */
        function startImportProgressTracking(operationId) {
            currentImportOperationId = operationId;
            ...
            importInterval = setInterval(() => {
                fetchImportProgress(operationId);
            }, 500);
        }

        /**
         * Récupère la progression d'import depuis le serveur
         */
        async function fetchImportProgress(operationId) {
            try {
                const response = await fetch(`/contacts/import/progress/${operationId}`);
                ...
                if (data.success && data.progress) {
                    ...
                    document.getElementById('importSuccessCount').textContent = progress.imported;
                    document.getElementById('importErrorCount').textContent = progress.errors;
                    document.getElementById('importDuplicateCount').textContent = progress.duplicates;
                    ...
                    if (progress.status === 'completed') {
                        clearInterval(importInterval);
                        importInterval = null;
                        currentImportOperationId = null;

                        // Afficher le succès
                        setTimeout(() => {
                            let message = `${progress.imported} contacts importés avec succès.`;
                            if (progress.duplicates > 0) {
                                message += ` ${progress.duplicates} doublons ignorés.`;
                            }
                            if (progress.errors > 0) {
                                message += ` ${progress.errors} erreurs.`;
                            }

                            showAlert('Import terminé', message, 'success');
                ...
                console.error('Erreur récupération progression import:', error);
            }
        }

        // =====================================================
        // SYSTÈME DE PROGRESSION EN TEMPS RÉEL - CAMPAGNE
        // =====================================================

        /**
         * Démarre le suivi de progression de campagne
         */
        function startCampaignProgressTracking(operationId) {
            currentCampaignOperationId = operationId;
            ...
            campaignInterval = setInterval(() => {
                fetchCampaignProgress(operationId);
            }, 500);
        }

        /**
         * Récupère la progression de campagne depuis le serveur
         */
        async function fetchCampaignProgress(operationId) {
            try {
                const response = await fetch(`/twilio/campaign/progress/${operationId}`);
                const data = await response.json();
                ...
                if (data.success && data.progress) {
                    ...
                    // Mettre à jour les détails
                    document.getElementById('sendSuccessCount').textContent = progress.success;
                    document.getElementById('sendErrorCount').textContent = progress.errors;
                    document.getElementById('sendPendingCount').textContent = progress.total - progress.processed;
                    ...
                    if (progress.status === 'completed') {
                        ...
                        currentCampaignOperationId = null;

                        // Afficher le succès
                        setTimeout(() => {
                            const message =
                                `Campagne terminée: ${progress.success} messages envoyés, ${progress.errors} erreurs.`;
                            showAlert('Campagne terminée', message, 'success');
                ...
                console.error('Erreur récupération progression campagne:', error);
            }
        }

        // =====================================================
        // IMPORT CSV AVEC PROGRESSION EN TEMPS RÉEL
        // =====================================================
        ...
        async function startImport() {
            ...
            showConfirmation(
                ...
                async () => {
                    ...
                    updateImportProgress(0, 100, 'Lecture du fichier...');
                    ...
                    try {
                        ...
                        if (result.success && result.operation_id) {
                            ...
                            console.log('Démarrage du suivi import:', result.operation_id);
                            startImportProgressTracking(result.operation_id);
                        } else {
        ...
        // =====================================================
        // ENVOI DE CAMPAGNE AVEC PROGRESSION EN TEMPS RÉEL
        // =====================================================
            ...
            showConfirmation(
                ...
                async () => {
                    ...
                    try {
                        ...
                        if (result.success && result.operation_id) {
                            // Démarrer le suivi en temps réel
                            console.log('Démarrage du suivi campagne:', result.operation_id);
                            startCampaignProgressTracking(result.operation_id);
                        } else {
        ...
        function stopCampaignSend() {
            ...
            sendInProgress = false;
            document.getElementById('sendProgressMessage').textContent = 'Envoi arrêté par l\'utilisateur';
            document.getElementById('sendCampaignButton').classList.remove('hidden');
            document.getElementById('stopSendButton').classList.add('hidden');
            document.getElementById('cancelSendButton').disabled = false;
        }
        ...
        async function sendToSelected() {
            ...
            const firstContactRow = document.querySelector(
            `.contact-row[data-id="${Array.from(selectedContacts)[0]}"]`);
        ...
        function updateSendSummary() {
            ...
            document.getElementById('summaryDetails').textContent =
                `Délai estimé: ~${Math.ceil(estimatedCount * 0.5)} secondes`;
                    ...
                    fetch(`/twilio/send-contact/${contactId}`, {
                        ...
                        .then(async response => {
                            ...
                            if (contentType && contentType.includes('application/json')) {
                                ...
                                throw new Error(
                                    `Le serveur a retourné: ${response.status} ${response.statusText}`);
                            }
                        })
                        .then(data => {
                            hideLoader();
                            if (data && typeof data === 'object') {
                                showAlert(data.title || (data.success ? 'Succès' : 'Erreur'), data.message, data
        ...
        function openModal(modalId) {
            const isFormModal = ['addModal', 'importModal', 'sendCampaignModal', 'deleteModal', 'deleteCampaignModal']
                .includes(modalId);

            if (isFormModal) {
                document.querySelectorAll('[id$="Modal"]').forEach(modal => {
                    if (modal.id !== modalId && !modal.classList.contains('hidden') && ['addModal', 'importModal',
                            'sendCampaignModal', 'deleteModal', 'deleteCampaignModal'
                        ].includes(modal.id)) {
            ...
            if (modal && alertTitle && alertMessage && alertIcon) {
                ...
                switch (type) {
                    case 'success':
                        ...
                        iconSvg =
                            '<svg class="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>';
                        break;
                    case 'error':
                        bgColor = 'bg-red-100';
                        textColor = 'text-red-600';
                        iconSvg =
                            '<svg class="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/></svg>';
                        break;
                    case 'warning':
                        bgColor = 'bg-yellow-100';
                        textColor = 'text-yellow-600';
                        iconSvg =
                            '<svg class="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>';
                        break;
                    default:
                        bgColor = 'bg-blue-100';
                        textColor = 'text-blue-600';
                        iconSvg =
                            '<svg class="w-5 h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/></svg>';
                }

                alertIcon.className =
                    `w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center mr-3 flex-shrink-0 ${bgColor} ${textColor}`;
